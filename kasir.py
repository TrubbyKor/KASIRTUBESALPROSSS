...
class POS:
    def __init__(self, root):
        ...
        self.category_frame.grid(row=0, column=0, sticky="ns", padx=5, pady=5)
        
        self.items_frame = tk.Frame(self.root)
        self.items_frame.grid(row=0, column=1, sticky="nsew", padx=5, pady=5)
        
        self.cart_frame = tk.Frame(self.root)
        self.cart_frame.grid(row=0, column=2, sticky="nsew", padx=5, pady=5)
        ...
        self.cart_listbox = tk.Listbox(self.cart_frame, width=40, height=20)
